              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={async () => {
                    if (
                      !window.confirm(
                        "האם לנקות כפולים מקובץ התמלולים?"
                      )
                    )
                      return;
                    try {
                      const res = await fetch(
                        "/api/transcriptions/clean_duplicates",
                        { method: "POST" }
                      );
...
filteredTranscriptions.map((item) => (
                      <motion.div
                        ...
                        onClick={() =>
                          navigate(
                            createPageUrl(`TranscriptionView?id=${t.id}`)
                          )
                        }
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-600">
                  קבל סיכום אוטומטי של התמלולים הארוכים שלך
                </p>
      ...
      <Card className="relative overflow-hidden">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div
              className={`w-12 h-12 bg-gradient-to-r ${colorClasses[
                color
